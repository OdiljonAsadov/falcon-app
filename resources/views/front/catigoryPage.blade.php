    ...
    <div class="container">
      ...
      <div class="img-container">
        <div class="row justify-content-between">
          <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12"><img src="./images/9.png" alt="9" class="img-fluid"></div>
          <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12"><img src="./images/8.png" alt="9" class="img-fluid"></div>
          <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12"><img src="./images/7.png" alt="9" class="img-fluid"></div>
        </div>
      </div>
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium repudiandae perspiciatis similique omnis
        sit nemo, ipsam ducimus sequi explicabo distinctio voluptates officia, laboriosam ut aperiam, aspernatur
        sapiente. Distinctio, recusandae excepturi quisquam porro ipsam quo minus culpa, officia ut sapiente laudantium
        atque. Sit excepturi, expedita libero commodi impedit inventore tempora vitae?</p>

      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum cum nulla amet ipsam. Commodi aut eius maiores
